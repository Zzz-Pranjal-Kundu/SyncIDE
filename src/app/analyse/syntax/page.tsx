...
import {analyzeCode, Token as SyntaxToken} from "@/lib/analyzers/lexicalAnalyzer";
import {
  syntaxAnalyze,
  ParseNode,
...
export default function SyntaxPage() {
  ...
  const handleAnalyze = () => {
    ...
    const result = syntaxAnalyze(lexicalTokens);
  ...
  return (
    <div className="min-h-screen px-6 py-8 flex flex-col bg-[#12121f] text-white font-sans">
      <AnalyzeHeader text="Syntax Analyzer"/>
