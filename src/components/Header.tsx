...
const lobster = Michroma({
  subsets: ["latin"],
  weight: "400",
});

export default function AnalyzeHeader({ text }: { text?: string }) {
  return (
    <div className="relative z-10">
      <div className="flex items-center lg:justify-between justify-center bg-[#0b0b10]/90 backdrop-blur-md p-6 mb-4 rounded-lg relative">
        {/* Logo + Title on large screens */}
        ...
        {text && (
            <div className="absolute left-1/2 transform -translate-x-1/2 text-center">
                <h1 className={`${lobster.className} text-3xl tracking-wider bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-500 bg-clip-text text-transparent drop-shadow-md`}>
                {text}
                </h1>
            </div>
        )}
